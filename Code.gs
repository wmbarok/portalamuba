 ...
 * Handles doGet, database setup, and CRUD operations for E-Books, Events, Gallery, PPDB, and Admin Authentication.
 */
...
function submitPPDB(data) {
  ...
  if (!data.namaLengkap || !data.noTelepon) {
    throw new Error('Nama lengkap dan nomor telepon wajib diisi!');
  }
